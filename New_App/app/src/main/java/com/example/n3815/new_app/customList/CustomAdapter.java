...
public class CustomAdapter extends BaseAdapter {
    ...
    private ArrayList<CustomItem> customItemList = new ArrayList<CustomItem>() ;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView iconImageView = (ImageView) convertView.findViewById(R.id.img_icon) ;
        ...
        // Data Set(customItemList)에서 position에 위치한 데이터 참조 획득
        CustomItem listViewItem = customItemList.get(position);
